...
export const metadata: Metadata = {
  ...
  description: "Experience crafted specialty coffee at Coffee Haven. From rich espresso to smooth cold brew, discover premium beans and passionate baristas.",
  keywords: "specialty coffee, espresso, cappuccino, cold brew, coffee shop",
  openGraph: {
    title: "Coffee Haven - Premium Specialty Coffee",
    description: "Experience crafted specialty coffee at Coffee Haven. From rich espresso to smooth cold brew.",
